...
Gien a numeric variable this function will generate bins (or you can give it bin numbers or widths) and will tally up the variable into the bins and then plot a histogram...
